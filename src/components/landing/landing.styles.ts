...
export const COURSES_GRID = 'grid grid-cols-1 gap-3 md:grid-cols-5 md:grid-rows-4 md:h-[500px]';
export const COURSES_CARD_BASE = 'relative rounded-xl md:rounded-2xl overflow-hidden min-h-[180px] sm:min-h-[200px] md:min-h-0';
export const COURSES_CARD_1 = 'md:col-span-3 md:row-span-4';
export const COURSES_CARD_2 = 'md:col-span-2 md:row-span-2 md:col-start-4';
export const COURSES_CARD_3 = 'md:col-span-2 md:row-span-2 md:col-start-4 md:row-start-3';
export const COURSES_CARD_IMAGE = 'absolute inset-0 w-full h-full object-cover pointer-events-none select-none';

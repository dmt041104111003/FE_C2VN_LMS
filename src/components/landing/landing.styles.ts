export const HERO_SECTION = 'min-h-screen flex items-center py-12 md:py-16 px-4';
export const HERO_CONTAINER = 'max-w-6xl mx-auto w-full';
export const HERO_INNER = 'flex flex-col-reverse md:flex-row md:items-center gap-6 md:gap-12';
export const HERO_CONTENT = 'flex-1 text-center md:text-left';
export const HERO_IMAGE_WRAPPER = 'flex-1 flex items-center justify-center md:justify-end';
export const HERO_IMAGE = 'w-full max-w-[280px] sm:max-w-[320px] md:max-w-[450px] lg:max-w-[500px] h-auto pointer-events-none select-none';
export const HERO_SUBTITLE = 'text-xs sm:text-sm font-semibold uppercase tracking-wider text-[var(--text)]/60 mb-2 md:mb-3';
export const HERO_TITLE = 'text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[var(--text)] mb-3 md:mb-4';
export const HERO_DESC = 'text-sm sm:text-base md:text-lg text-[var(--text)]/70 mb-5 md:mb-8';
export const HERO_CTA = 'inline-flex items-center px-6 py-3 border-2 border-[var(--text)] text-[var(--text)] text-sm md:text-base font-medium rounded-full';
...
export const FEATURES_CARD_3 = "md:row-span-3 md:col-start-3 md:row-start-1 bg-[url('/landing/3.png')] bg-cover bg-center";
...
export const CTA_GRID = 'grid grid-cols-2 gap-2 md:grid-cols-5 md:grid-rows-5 h-full';
export const CTA_CELL_1 = 'md:row-span-3 bg-white/10 rounded-xl';
export const CTA_CELL_2 = 'md:row-span-2 md:col-start-1 md:row-start-4 bg-white/5 rounded-xl';
export const CTA_CELL_3 = 'md:col-span-2 md:row-span-2 md:col-start-2 md:row-start-3 bg-white/10 rounded-xl flex flex-col items-center justify-center p-6 text-center';
export const CTA_CELL_4 = 'md:row-span-2 md:col-start-2 md:row-start-1 bg-white/5 rounded-xl';
export const CTA_CELL_5 = 'md:row-span-2 md:col-start-3 md:row-start-1 bg-white/5 rounded-xl';
export const CTA_CELL_6 = 'md:row-span-3 md:col-start-4 md:row-start-1 bg-white/10 rounded-xl';
export const CTA_CELL_7 = 'md:row-span-3 md:col-start-5 md:row-start-1 bg-white/5 rounded-xl';
export const CTA_CELL_8 = 'md:col-span-2 md:row-span-2 md:col-start-4 md:row-start-4 bg-white/10 rounded-xl';
export const CTA_CELL_9 = 'md:col-span-2 md:col-start-2 md:row-start-5 bg-white/5 rounded-xl';

export const USER_PROFILE = {
  ...
  ROLE: 'text-xs uppercase tracking-widest text-[var(--text)]/40 mt-1',
  ...
  META_ITEM: 'flex items-center gap-1.5 text-xs text-[var(--text)]/40',
...
export const USER_STATS = {
  ...
  LABEL: 'text-xs uppercase tracking-widest text-[var(--text)]/40 mt-1',
} as const;

export const USER_SECTION = {
  CONTAINER: 'mb-12 sm:mb-16',
  TITLE: 'text-xs uppercase tracking-widest text-[var(--text)]/40 mb-6 sm:mb-8',
...
export const USER_COURSE_ITEM = {
  ...
  INSTRUCTOR: 'text-xs text-[var(--text)]/40 mt-0.5',
  ...
  PROGRESS_TEXT: 'text-xs text-[var(--text)]/40 min-w-[32px] sm:min-w-[40px] text-right',
  COMPLETED: 'flex items-center gap-1.5 text-xs text-[var(--accent)] mt-2',
} as const;
...
export const USER_CERTIFICATE_ITEM = {
  ...
  CONTENT: 'flex-1 min-w-0',
  TITLE: 'text-sm text-[var(--text)] group-hover:text-[var(--accent)] transition-colors line-clamp-1',
  META: 'text-xs text-[var(--text)]/40 mt-0.5',
} as const;
...
export const USER_EDIT = {
  ...
  FORM: 'space-y-8',
  SECTION: 'space-y-3',
  LABEL: 'text-xs uppercase tracking-widest text-[var(--text)]/40',

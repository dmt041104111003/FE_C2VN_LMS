...
export const MOCK_COURSE_STUDENTS: Record<string, CourseStudent[]> = {
  '1': [
    ...
    { id: '102', fullName: 'Trần Thị B', email: 'tranthib@gmail.com', walletAddress: 'addr1qxy...abc', enrolledAt: '2024-02-15T14:00:00Z', status: 'completed' },
    { id: '103', fullName: 'Lê Văn C', email: 'levanc@gmail.com', enrolledAt: '2024-03-10T09:00:00Z', status: 'active' },
    { id: '104', fullName: 'Phạm Thị D', email: 'phamthid@gmail.com', enrolledAt: '2024-04-05T11:00:00Z', status: 'active' },
    { id: '105', fullName: 'Hoàng Văn E', email: 'hoangvane@gmail.com', enrolledAt: '2024-05-20T16:00:00Z', status: 'active' },
    { id: '106', fullName: 'Ngô Thị F', email: 'ngothif@gmail.com', enrolledAt: '2024-06-01T08:00:00Z', status: 'completed' },
    ...
    { id: '109', fullName: 'Bùi Văn I', email: 'buivani@gmail.com', enrolledAt: '2024-07-10T09:00:00Z', status: 'completed' },
    { id: '110', fullName: 'Trương Thị K', email: 'truongthik@gmail.com', enrolledAt: '2024-07-20T11:00:00Z', status: 'active' },
    { id: '111', fullName: 'Lý Văn L', email: 'lyvanl@gmail.com', enrolledAt: '2024-08-01T08:30:00Z', status: 'active' },
    { id: '112', fullName: 'Hồ Thị M', email: 'hothim@gmail.com', enrolledAt: '2024-08-15T15:00:00Z', status: 'completed' },
    ...
    { id: '115', fullName: 'Đinh Văn P', email: 'dinhvanp@gmail.com', enrolledAt: '2024-10-01T09:30:00Z', status: 'completed' },
  ],
  '2': [
    { id: '201', fullName: 'Võ Thị F', email: 'vothif@gmail.com', enrolledAt: '2024-03-25T10:00:00Z', status: 'completed' },
    { id: '202', fullName: 'Đặng Văn G', email: 'dangvang@gmail.com', enrolledAt: '2024-04-10T14:00:00Z', status: 'active' },
  ],
};
